...
from excl_internship_tracker.users.models import User
from excl_internship_tracker.users.tests.factories import UserFactory
from excl_internship_tracker.users.views import (
    UserRedirectView,
    UserUpdateView,
    user_detail_view,
)
